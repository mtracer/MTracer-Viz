...
private void calThreshold(){
	...
	/*added */
/*	double[] variances=new double[colNum-principalComponentNum+1];//principalComponentNum, rather than principalComponentNum+1
	for(int i=0;i<variances.length;i++)
		variances[i]=eigenvalues[principalComponentNum-1+i];//principalComponentNum,rather than principalComponentNum-1
*/	/*added */
