...
session.setAttribute("prepareTime",et1-st1);
session.setAttribute("diagnosisTime",et2-st2);
String url="index.jsp?taskID=usesession&sessionKey=abnormalTasks&sortValue=delay&sortStyle=descend";
