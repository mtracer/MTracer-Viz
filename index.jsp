...
<a href="index.jsp">Return Home</a> &gt;&gt;<B>Tasks</B> | <a href="op_index.jsp">Operations</a> | 
...
/*if(taskIDType.equals("usesession")){
...
if(isAbnormalList.equals("true")){
	...
	Long t1=(Long)session.getAttribute("prepareTime");
	Long t2=(Long)session.getAttribute("diagnosisTime");
	out.print("<p>Prepare time is "+t1+" ms, and diagnosis time is "+t2+" ms<p>");
}
else
